...
import type { AttendanceStatus, Player } from '@/features/player-database/types'

interface AttendanceClientProps {
  initialPlayer: Player
}

export default function CoachPlayerAttendanceClient({ initialPlayer }: AttendanceClientProps) {
