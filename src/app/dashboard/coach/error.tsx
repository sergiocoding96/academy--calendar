  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-8">
      <div className="max-w-md w-full bg-white rounded-2xl border border-stone-200 p-8 text-center shadow-sm">
        ...
        <h2 className="text-lg font-bold text-stone-800 mb-2">Failed to load coach dashboard</h2>
        <p className="text-stone-500 text-sm mb-6">
          {error.message || 'Could not retrieve your coaching data. This may be a temporary issue.'}
        </p>
