...
import type { AttendanceStatus, Attendance, Player } from '@/features/player-database/types'
...
export function AttendanceClient({ initialPlayers }: AttendanceClientProps) {
  ...
  }, [initialPlayers.length, selectedDate])
  ...
  const filteredPlayers = useMemo(() => {
    const activePlayers = initialPlayers.filter(p => p.is_active !== false)
  ...
  }, [initialPlayers, attendanceMap, filter])
